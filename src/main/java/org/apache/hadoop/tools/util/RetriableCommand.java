...
public abstract class RetriableCommand {
  ...
  private static Log LOG = LogFactory.getLog(org.apache.hadoop.tools.util.RetriableCommand.class);
   ...
   * @throws java.io.IOException, IOException, on complete failure.
   */
   ...
   * @return Self.
   */
  public org.apache.hadoop.tools.util.RetriableCommand setRetryPolicy(RetryPolicy retryHandler) {
