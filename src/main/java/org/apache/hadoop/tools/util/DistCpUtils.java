...
public class DistCpUtils {
  ...
  private static final Log LOG = LogFactory.getLog(org.apache.hadoop.tools.util.DistCpUtils.class);
   ...
   * @throws java.io.IOException - Exception if any (particularly relating to group/owner
   ...
   * @throws java.io.IOException - Any exception during sort.
   */
   ...
   * @throws org.apache.hadoop.tools.CopyListing.AclsNotSupportedException if fs does not support ACLs
   */
   ...
   *
   * @param fs FileSystem to check
   * @throws org.apache.hadoop.tools.CopyListing.XAttrsNotSupportedException if fs does not support XAttrs
   */
   ...
   * and false otherwise.
   * @throws java.io.IOException if there's an exception while retrieving checksums.
   */
