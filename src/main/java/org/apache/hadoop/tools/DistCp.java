...
public class DistCp extends Configured implements Tool {
  ...
  protected Path createInputFileListing(Job job) throws IOException {
    ...
    org.apache.hadoop.tools.CopyListing copyListing = CopyListing.getCopyListing(job.getConfiguration(),
  ...
  private static class Cleanup implements Runnable {
    private final org.apache.hadoop.tools.DistCp distCp;

    public Cleanup(org.apache.hadoop.tools.DistCp distCp) {
      this.distCp = distCp;
    }
