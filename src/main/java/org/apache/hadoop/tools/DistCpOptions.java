...
public class DistCpOptions {
   ...
   */
  public DistCpOptions(org.apache.hadoop.tools.DistCpOptions that) {
  ...
  public void setAtomicCommit(boolean atomicCommit) {
    validate(org.apache.hadoop.tools.DistCpOptionSwitch.ATOMIC_COMMIT, atomicCommit);
  ...
  public void setSyncFolder(boolean syncFolder) {
    validate(org.apache.hadoop.tools.DistCpOptionSwitch.SYNC_FOLDERS, syncFolder);
  ...
  public void setDeleteMissing(boolean deleteMissing) {
    validate(org.apache.hadoop.tools.DistCpOptionSwitch.DELETE_MISSING, deleteMissing);
  ...
  public void setOverwrite(boolean overwrite) {
    validate(org.apache.hadoop.tools.DistCpOptionSwitch.OVERWRITE, overwrite);
  ...
  public void setAppend(boolean append) {
    validate(org.apache.hadoop.tools.DistCpOptionSwitch.APPEND, append);
    this.append = append;
  }
  ...
  public void setSkipCRC(boolean skipCRC) {
    validate(org.apache.hadoop.tools.DistCpOptionSwitch.SKIP_CRC, skipCRC);
  ...
  public void validate(org.apache.hadoop.tools.DistCpOptionSwitch option, boolean value) {

    boolean syncFolder = (option == org.apache.hadoop.tools.DistCpOptionSwitch.SYNC_FOLDERS ?
        value : this.syncFolder);
    boolean overwrite = (option == org.apache.hadoop.tools.DistCpOptionSwitch.OVERWRITE ?
        value : this.overwrite);
    boolean deleteMissing = (option == org.apache.hadoop.tools.DistCpOptionSwitch.DELETE_MISSING ?
        value : this.deleteMissing);
    boolean atomicCommit = (option == org.apache.hadoop.tools.DistCpOptionSwitch.ATOMIC_COMMIT ?
        value : this.atomicCommit);
    boolean skipCRC = (option == org.apache.hadoop.tools.DistCpOptionSwitch.SKIP_CRC ?
        value : this.skipCRC);
    boolean append = (option == org.apache.hadoop.tools.DistCpOptionSwitch.APPEND ? value : this.append);
  ...
  public void appendToConf(Configuration conf) {
    org.apache.hadoop.tools.DistCpOptionSwitch.addToConf(conf, org.apache.hadoop.tools.DistCpOptionSwitch.ATOMIC_COMMIT,
        String.valueOf(atomicCommit));
    org.apache.hadoop.tools.DistCpOptionSwitch.addToConf(conf, org.apache.hadoop.tools.DistCpOptionSwitch.IGNORE_FAILURES,
        String.valueOf(ignoreFailures));
    org.apache.hadoop.tools.DistCpOptionSwitch.addToConf(conf, org.apache.hadoop.tools.DistCpOptionSwitch.SYNC_FOLDERS,
        String.valueOf(syncFolder));
    org.apache.hadoop.tools.DistCpOptionSwitch.addToConf(conf, org.apache.hadoop.tools.DistCpOptionSwitch.DELETE_MISSING,
        String.valueOf(deleteMissing));
    org.apache.hadoop.tools.DistCpOptionSwitch.addToConf(conf, org.apache.hadoop.tools.DistCpOptionSwitch.OVERWRITE,
        String.valueOf(overwrite));
    org.apache.hadoop.tools.DistCpOptionSwitch.addToConf(conf, org.apache.hadoop.tools.DistCpOptionSwitch.APPEND,
        String.valueOf(append));
    org.apache.hadoop.tools.DistCpOptionSwitch.addToConf(conf, org.apache.hadoop.tools.DistCpOptionSwitch.SKIP_CRC,
        String.valueOf(skipCRC));
    org.apache.hadoop.tools.DistCpOptionSwitch.addToConf(conf, org.apache.hadoop.tools.DistCpOptionSwitch.BANDWIDTH,
        String.valueOf(mapBandwidth));
    org.apache.hadoop.tools.DistCpOptionSwitch.addToConf(conf, DistCpOptionSwitch.PRESERVE_STATUS,
  ...
  @Override
  protected org.apache.hadoop.tools.DistCpOptions clone() throws CloneNotSupportedException {
    return (org.apache.hadoop.tools.DistCpOptions) super.clone();
  }
}
