...
public class OptionsParser {
  ...
  private static final Log LOG = LogFactory.getLog(org.apache.hadoop.tools.OptionsParser.class);
   ...
   */
  public static org.apache.hadoop.tools.DistCpOptions parse(String args[]) throws IllegalArgumentException {
    ...
    org.apache.hadoop.tools.DistCpOptions option;
    Path targetPath;
    ...
    if (command.hasOption(DistCpOptionSwitch.SOURCE_FILE_LISTING.getSwitch())) {
      ...
      option = new org.apache.hadoop.tools.DistCpOptions(new Path(getVal(command, DistCpOptionSwitch.
