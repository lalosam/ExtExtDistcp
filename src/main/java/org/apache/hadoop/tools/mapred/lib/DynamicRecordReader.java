...
public class DynamicRecordReader<K, V> extends RecordReader<K, V> {
  private static final Log LOG = LogFactory.getLog(org.apache.hadoop.tools.mapred.lib.DynamicRecordReader.class);
  private TaskAttemptContext taskAttemptContext;
  private Configuration configuration;
  private org.apache.hadoop.tools.mapred.lib.DynamicInputChunk<K, V> chunk;
  ...
  public void initialize(InputSplit inputSplit,
    ...
    chunk = org.apache.hadoop.tools.mapred.lib.DynamicInputChunk.acquire(this.taskAttemptContext);
  ...
  public boolean nextKeyValue()
    ...
    chunk = org.apache.hadoop.tools.mapred.lib.DynamicInputChunk.acquire(taskAttemptContext);
  ...
  private int getNumChunksLeft() throws IOException {
    ...
    if (tooLongSinceLastDirScan
      ...
      org.apache.hadoop.tools.mapred.lib.DynamicInputChunk.getListOfChunkFiles();
      isChunkDirAlreadyScanned = true;
      timeOfLastChunkDirScan = now;
    }

    return org.apache.hadoop.tools.mapred.lib.DynamicInputChunk.getNumChunksLeft();
  }
  /**
