...
public class DynamicInputFormat<K, V> extends InputFormat<K, V> {
  private static final Log LOG = LogFactory.getLog(org.apache.hadoop.tools.mapred.lib.DynamicInputFormat.class);
  ...
  private List<InputSplit> createSplits(JobContext jobContext,
                                        List<org.apache.hadoop.tools.mapred.lib.DynamicInputChunk> chunks)
          throws IOException {
  ...
  private List<org.apache.hadoop.tools.mapred.lib.DynamicInputChunk> splitCopyListingIntoChunksWithShuffle
    ...
    List<org.apache.hadoop.tools.mapred.lib.DynamicInputChunk> openChunks
                  = new ArrayList<org.apache.hadoop.tools.mapred.lib.DynamicInputChunk>();

    List<org.apache.hadoop.tools.mapred.lib.DynamicInputChunk> chunksFinal = new ArrayList<org.apache.hadoop.tools.mapred.lib.DynamicInputChunk>();
  ...
  private static void closeAll(List<org.apache.hadoop.tools.mapred.lib.DynamicInputChunk> chunks) {
    for (org.apache.hadoop.tools.mapred.lib.DynamicInputChunk chunk: chunks)
      chunk.close();
  }

  private static List<org.apache.hadoop.tools.mapred.lib.DynamicInputChunk> createChunks(Configuration config,
                      int chunkCount, int nChunksTotal, int nChunksOpenAtOnce)
                                          throws IOException {
    List<org.apache.hadoop.tools.mapred.lib.DynamicInputChunk> chunks = new ArrayList<org.apache.hadoop.tools.mapred.lib.DynamicInputChunk>();
  ...
  private static org.apache.hadoop.tools.mapred.lib.DynamicInputChunk createChunk(int chunkId, Configuration config)
                                              throws IOException {
    return org.apache.hadoop.tools.mapred.lib.DynamicInputChunk.createChunkForWrite(String.format("%05d", chunkId),
                                              config);
  }
