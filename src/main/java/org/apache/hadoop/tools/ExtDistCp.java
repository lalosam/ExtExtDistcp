...
import org.apache.hadoop.tools.mapred.ExtCopyMapper;
 ...
 */
public class ExtDistCp extends Configured implements Tool {
     ...
     */
    public ExtDistCp(Configuration configuration, DistCpOptions inputOptions) throws Exception {
    ...
    private Job createJob() throws IOException {
        ...
        job.setJarByClass(ExtCopyMapper.class);
        configureOutputFormat(job);

        job.setMapperClass(ExtCopyMapper.class);
    ...
    public static void main(String argv[]) {
        ...
        try {
            ExtDistCp distCp = new ExtDistCp();
    ...
    private static class Cleanup implements Runnable {
        private final ExtDistCp distCp;

        public Cleanup(ExtDistCp distCp) {
            this.distCp = distCp;
        }
